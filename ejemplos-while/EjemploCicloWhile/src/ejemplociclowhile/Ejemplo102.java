...
// cadena acumulador
        ...
        while (contador <= limite_tabla){
            ...
            operacion_multiplicacion = tabla * contador;
            operacion_suma = tabla + contador;
            operacion_resta = tabla - contador;
        ...
        System.out.printf("Tabla de suma\n%s\nTabla de resta\n%s\nTabla de multiplicar\n%s", cadena1,cadena2,cadena3);
